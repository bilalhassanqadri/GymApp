  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 0.0,
        title: Text('Macro Calculator',style: TextStyle(color: blue,fontSize: 22),),
        ...
        children: [
          ...
          Center(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(' Activity',style: TextStyle(fontWeight: FontWeight.w500,color: Colors.black,fontSize: 14),),
                ...
                Container(
                  ...
                  child: TextFormField(
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Icon(Icons.location_on,color: border,),
          ...
          Center(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(' Your Goal',style: TextStyle(fontWeight: FontWeight.w500,color: Colors.black,fontSize: 14),),
                const SizedBox(height: 10,),
                Container(
                  height: 60,
                  width: MediaQuery.of(context).size.width/1.1,

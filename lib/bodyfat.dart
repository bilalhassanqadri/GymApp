...
class _MacroState extends State<BodyFat> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 0.0,
        title: Text('Body Fat Calculator',style: TextStyle(color: blue,fontSize: 22),),
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Neck',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 14),),
                  SizedBox(height: 10,),
                  Container(
                    width: MediaQuery.of(context).size.width/2,
                    decoration: BoxDecoration(
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Waist',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 14),),
                  SizedBox(height: 10,),
                  Container(
                    width: MediaQuery.of(context).size.width/2,
                    decoration: BoxDecoration(
